    ...
    <div class="layout">
      <section class="card">
        ...
        <form id="setup-form">
          ...
          <div class="choices">
            <label class="choice"><input type="radio" name="integration" value="hosted-calendar" checked /><span><strong>Use an OpenSlot hosted calendar</strong><p>Good for practices that do not have an online scheduling system. This demo uses sample availability.</p></span></label>
